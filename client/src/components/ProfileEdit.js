        ...
        <div className="profile-card">
          <div className="profile-card__img-body">
            ...
            <div className="profile-card__upload-img">
              ...
              <input
                ...
                ref={imgFile}
              />
              <div className="profile-card__upload--button" onClick={uploadImg}>
                <span>Submit</span>
              </div>
            </div>
          </div>
          <div className="profile-card__bio--container">
            <div className="profile-card__text-box">
              <div className="profile-card__field" id="profile-card__username">
                {props.user.username}
              </div>
              <div className="profile-card__field" id="profile-card__email">
                {props.user.email}
              </div>
              <div className="profile-card__field" id="profile-card__firstname">
                {props.user.firstname}
              </div>
              <div className="profile-card__field" id="profile-card__lastname">
                {props.user.lastname}
              </div>
              <div className="profile-card__field" id="profile-card__skill">
                {props.user.skill}
              </div>
            </div>
            <div className="profile-card__about--container">
              <div className="profile-card__field" id="profile-card__about">
                {props.user.about}
              </div>
            </div>
          </div>
