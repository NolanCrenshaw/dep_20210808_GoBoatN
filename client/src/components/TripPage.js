...
//             <option value="24">24</option>
//           </select>
//           <div id="trippage-body__trip-time-edit" onClick={setTime}>
//             <span>Set Time</span>
//           </div>
//         </div>
//       );
...
//         `${BASE_URL}/api/trips/${props.match.params.id}`,
//         {
//           method: "GET",
//           mode: "cors",
//           headers: {
...
//         setTripDate(tripTime.toLocaleString("en-US", options).split(/[\,,\s]/));
//         setTripTime(tripTime.toLocaleTimeString("en-US").split(/[:,\s]/));
//       }
//     };
//     getTrip();
//   }, []);
...
//               </div>
//             </div>
//             <div className="trippage__icon--container"></div>
//           </div>
